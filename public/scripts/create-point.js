...
function handleSelectedItem(event){
    ...
    if(alreadySelected >= 0){
        ...
        //se nao tiver selecionado add seleção
        selectedItems.push(itemId)

    }

    console.log('Select item id: ', selectedItems)

    //atualizar o campo escondido (hiddem) com os itens selecionados
